...
public class Chat4 {
    ...
    @FXML
    private Text msgTxt1;

    @FXML
    private TextField inputMsg;

    @FXML
    private TextField findNameChat;

    @FXML
    private Rectangle msgField;
    ...
    public void findBtn2Action(){
        ...
        {
            String input1 = findNameChat.getText();
            if(input1=="")
            {
    ...
    void newMsg(){
        ...
        if(msgTxt1.getText() != "")
        {
            ...
            msgTxt1.setVisible(true);
            inputMsg.setText("");
        }
        else {
            msgField.setVisible(false);
            msgTxt1.setVisible(false);
        }
    }
